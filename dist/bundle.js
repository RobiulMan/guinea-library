...
/* harmony export */   "ApiSync": () => (/* binding */ ApiSync)
/* harmony export */ });
...
class ApiSync {
    ...
    fetch(id) {
        return axios__WEBPACK_IMPORTED_MODULE_0___default().get(`${this.rootUrl}/${id}`);
    }
    save(data) {
        const { id } = data;
        if (id) {
            // put
            return axios__WEBPACK_IMPORTED_MODULE_0___default().put(`${this.rootUrl}/${id}`, data);
        }
        else {
            // post
            return axios__WEBPACK_IMPORTED_MODULE_0___default().post(this.rootUrl, data);
        }
    }
}
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Eventing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Eventing */ "./src/models/Eventing.ts");
...
class Collection {
    constructor(rootURL, deserialize) {
        ...
        this.models = [];
        this.events = new _Eventing__WEBPACK_IMPORTED_MODULE_1__.Eventing();
    }
    get on() {
    ...
    fetch() {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.rootURL).then((res) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Eventing": () => (/* binding */ Eventing)
/* harmony export */ });
class Eventing {
    constructor() {
        this.events = {};
...
/* harmony export */ });
class Model {
    constructor(attribute, events, sync) {
...
/* harmony export */ });
/* harmony import */ var _ApiSync__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ApiSync */ "./src/models/ApiSync.ts");
/* harmony import */ var _Attributes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Attributes */ "./src/models/Attributes.ts");
/* harmony import */ var _Collection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Collection */ "./src/models/Collection.ts");
/* harmony import */ var _Eventing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Eventing */ "./src/models/Eventing.ts");
/* harmony import */ var _Model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Model */ "./src/models/Model.ts");
...
class User extends _Model__WEBPACK_IMPORTED_MODULE_4__.Model {
    static buildUser(attrs) {
        return new User(new _Attributes__WEBPACK_IMPORTED_MODULE_1__.Attributes(attrs), new _Eventing__WEBPACK_IMPORTED_MODULE_3__.Eventing(), new _ApiSync__WEBPACK_IMPORTED_MODULE_0__.ApiSync(rootUrl));
    }
    static buildUserCollection() {
        return new _Collection__WEBPACK_IMPORTED_MODULE_2__.Collection("http://localhost:3000/users", (json) => User.buildUser(json));
    }
    setRandomAge() {
...
/* harmony export */ });
/* harmony import */ var _CollectionView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CollectionView */ "./src/view/CollectionView.ts");
/* harmony import */ var _UserShow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UserShow */ "./src/view/UserShow.ts");


class UserList extends _CollectionView__WEBPACK_IMPORTED_MODULE_0__.CollectionView {
    renderItem(model, parentItem) {
        new _UserShow__WEBPACK_IMPORTED_MODULE_1__.UserShow(parentItem, model).render();
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "UserShow": () => (/* binding */ UserShow)
/* harmony export */ });
/* harmony import */ var _View__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./View */ "./src/view/View.ts");

class UserShow extends _View__WEBPACK_IMPORTED_MODULE_0__.View {
    template() {
        return `
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _models_Collection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Collection */ "./src/models/Collection.ts");
/* harmony import */ var _models_User__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/User */ "./src/models/User.ts");
/* harmony import */ var _view_UserList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/UserList */ "./src/view/UserList.ts");



const users = new _models_Collection__WEBPACK_IMPORTED_MODULE_0__.Collection("http://localhost:3000/users", (json) => {
    return _models_User__WEBPACK_IMPORTED_MODULE_1__.User.buildUser(json);
});
users.on("change", () => {
    const root = document.querySelector("#root");
    if (root) {
        new _view_UserList__WEBPACK_IMPORTED_MODULE_2__.UserList(root, users).render();
    }
});
users.fetch();
